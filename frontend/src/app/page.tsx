        ...
        <div className="px-6 lg:px-10 py-8 max-w-[1400px] mx-auto">
          ...
          <div className="mb-8 animate-fade-in">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-[12px] font-semibold text-[var(--color-ink-muted)] uppercase tracking-wider mb-1">
          ...
          {!selectedPlatformId ? (
            ...
            <div className="animate-fade-in">
              <div className="bg-[var(--color-surface)] rounded-[var(--radius-lg)] border border-[var(--color-border)] p-8 max-w-lg">
                <div className="w-12 h-12 rounded-[var(--radius-md)] bg-[var(--color-canvas)] flex items-center justify-center mb-4">
            ...
            <>
              ...
              <div className="bg-[var(--color-surface)] rounded-[var(--radius-lg)] border border-[var(--color-border)] animate-fade-in" style={{ animationDelay: "200ms" }}>
                <div className="px-6 py-4 border-b border-[var(--color-border-subtle)] flex items-center justify-between">
                  ...
                  <a href="/transactions" className="text-[13px] font-semibold text-[var(--color-primary)] hover:text-[var(--color-primary-hover)] transition-colors">
                    View all
                  </a>
                </div>
                ...
                {loading ? (
                  ...
                  <div className="px-6 py-12">
                    <div className="flex items-start gap-4 p-4 bg-[var(--color-canvas)] rounded-[var(--radius-md)] border border-dashed border-[var(--color-border)]">
                      <div className="w-10 h-10 rounded-[var(--radius-md)] bg-[var(--color-surface)] flex items-center justify-center shrink-0">
                        <svg className="w-5 h-5 text-[var(--color-ink-muted)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                          <path strokeLinecap="round" strokeLinejoin="round" d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4" />
                        </svg>
                      </div>
                      <div>
                    ...
                    <table className="w-full text-[13px]">
                      ...
                      <tbody>
                        {transactions.map((tx) => (
                          <tr
                            key={tx.id}
                            className="border-b border-[var(--color-border-subtle)] last:border-0 table-row-hover"
                          >
              ...
              {/* Quick action hint */}
              {transactions.length > 0 && (
                <div className="mt-6 flex items-center gap-3 px-4 py-3 bg-[var(--color-surface)] rounded-[var(--radius-lg)] border border-[var(--color-border)]" style={{ animationDelay: "400ms" }}>
                  <div className="w-8 h-8 rounded-[var(--radius-md)] bg-[var(--color-canvas)] flex items-center justify-center shrink-0">
                    <svg className="w-4 h-4 text-[var(--color-ink-muted)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  ...
                  <a href="/split-rules" className="text-[12px] font-semibold text-[var(--color-primary)] hover:text-[var(--color-primary-hover)] transition-colors shrink-0">
                    Check rules
                  </a>
                </div>
              )}
